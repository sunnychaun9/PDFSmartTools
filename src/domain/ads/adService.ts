...
// TODO: Create a separate interstitial ad unit in AdMob console.
// Currently BANNER and INTERSTITIAL share the same ad unit ID which is incorrect.
// Replace the INTERSTITIAL value with the new ad unit ID once created.
const PRODUCTION_AD_UNIT_IDS = {
  BANNER: 'ca-app-pub-2002876774760881/9314442021',
  INTERSTITIAL: 'ca-app-pub-2002876774760881/9314442021', // FIXME: duplicate of BANNER — needs own ad unit
};
