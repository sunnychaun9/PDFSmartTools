...
import { saveSignature } from '../../../data/storage/signatureService';
...
export default function SignatureCreateScreen() {
  ...
  const webStyle = `
    .m-signature-pad {
      box-shadow: none;
      border: none;
      background-color: ${isDark ? theme.surfaceVariant : colors.surface};
    }
      ...
      <View style={styles.content}>
        ...
        <View
          style={[
            ...
            {
              backgroundColor: isDark ? theme.surfaceVariant : colors.surface,
        ...
        >
          <SignatureScreen
            ...
            webStyle={webStyle}
            backgroundColor={isDark ? theme.surfaceVariant : colors.surface}
            penColor={isDark ? colors.dark.textPrimary : colors.textPrimary}
            minWidth={2}
            maxWidth={4}
            trimWhitespace={true}
            imageType="image/png"
