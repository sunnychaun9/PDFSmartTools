...
/**
 * Signature position in Android coordinate space.
 * Origin at top-left, Y increases downward.
 * All values in PDF points (1/72 inch), scaled from screen coordinates.
 *
 * The native engine translates to PDF coordinate space (origin bottom-left, Y up)
 * using: pdfY = pageHeight - y - height
 */
 ...
 *
 * Uses structural PDFBox content stream overlay — preserves text layers,
 * searchability, and file size. Only the signed page is modified; all
 * other pages pass through untouched.
 */
