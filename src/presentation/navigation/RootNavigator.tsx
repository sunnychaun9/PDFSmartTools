...
let DebugEngineTestScreen: React.ComponentType<any> | null = null;
if (__DEV__) {
  try {
    DebugEngineTestScreen = require('../screens/debug-stress-test/DebugEngineTestScreen').default;
  } catch (_) {}
}
  ...
  return (
    ...
    >
      ...
      <Stack.Screen
        ...
        options={{ animation: 'slide_from_bottom' }}
      />
      {__DEV__ && DebugEngineTestScreen && (
        <Stack.Screen
          name="DebugStressTest"
          component={DebugEngineTestScreen}
          options={{ animation: 'slide_from_bottom' }}
        />
      )}
    </Stack.Navigator>
