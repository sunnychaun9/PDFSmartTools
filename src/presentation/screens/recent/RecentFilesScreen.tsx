...
import {
  ...
  type RecentFile,
  type RecentFileType,
} from '../../../data/storage/recentFilesService';
...
const FileCard = memo(function FileCard({ item, onPress, onLongPress, index }: FileCardProps) {
...
export default memo(RecentFilesScreen);
