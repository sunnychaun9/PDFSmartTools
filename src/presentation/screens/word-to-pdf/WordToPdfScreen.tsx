...
import {
  ...
  moveConvertedFile,
  formatFileSize,
  getErrorMessage as getWordConversionErrorMessage,
  validateWordFile,
  ConversionResult,
} from '../../../native/wordToPdfService';
import { getErrorMessage } from '../../../infrastructure/error/safeOperations';
import { pickWordFile, PickedFile, cleanupPickedFile } from '../../../native/filePicker';
...
export default function WordToPdfScreen() {
  ...
  const handleConvert = useCallback(async () => {
    ...
    try {
      ...
      const message = getWordConversionErrorMessage(errorCode, err.message);
